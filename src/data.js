export default {
    ...
    {
        "name" : "RAMPWALK",
        "about" : `The stage is set for a ramp walk, exquisite patterns, flair for design and confidence to pull it off is what this event is about.
        A perfect opportunity for all the fashionistas to glam up the stage in style!
        `,
        "overview" : `
        •	Participants need to enroll themselves to participate 
        •	Participants will be assigned slots based on order of registration 
        •	-A time limit will be set for each participant to showcase their design through a ramp walk
        •	-Result will be declared based entirely on the discretion of the judges.
        `,
        "rules and regulations " : `
        •	Participants need to style themselves, for ethical reasons.
        •	Participants need to adhere to the given time limit
        •	Profanity and vulgarity will lead to immediate disqualification
        •	Participants will be judged based on the best outfit and overall best rampwalk 
        •	The decision of the judges is final and up for no discussion
        `,
        "requirements" : `•	-Venue: classroom or trp
        •	-Judges
        •	-Mic for the emcee
        •	-Space for the participants to get ready
        •	-Speakers, if participants wish to play music during their rampwalk
        •	-Emcee
        •	-Volunteers to ensure smooth flow of event
        -	Writing pad for judges
        `,
        "venue" : "",
        "duration" : "",
        "registrationLink" : "",
